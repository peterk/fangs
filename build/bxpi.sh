...
APP_NAME=fangs    # short-name, jar and xpi files name.
...
ROOT_FILES="chrome.manifest install.rdf install.js" # put these files in root of xpi
#### editable items end
